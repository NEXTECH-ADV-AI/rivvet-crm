    ...
    <main className="grid min-h-[calc(100dvh-var(--grok-banner-h,0px))] place-items-center bg-deep-ink px-4 py-10 text-white">
      <div className="w-full max-w-sm space-y-6">
        ...
        <p className="text-sm text-white/60">
          Magic link via Supabase (email through Resend in your project). Links
          open this CRM — not app.rivvetai.com. Google / X when platform auth is
          on.
        </p>
              ...
              <div className="space-y-2 rounded-md border border-bright-mint/25 bg-bright-mint/10 px-3 py-3 text-sm">
                ...
                {redirectHint && !previewUrl && (
                  <p className="text-xs text-white/55">
                    ...
                    {" "}→ /auth/callback. If you still hit app.rivvetai.com, add
                    that URL to Supabase Auth → Redirect URLs.
                  </p>
                )}
                {previewUrl && (
                  <a
